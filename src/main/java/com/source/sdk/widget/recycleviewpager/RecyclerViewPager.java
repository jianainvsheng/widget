package com.source.sdk.widget.recycleviewpager;
...
import com.source.sdk.widget.recycleviewpager.adapter.RecyclerViewPagerAdapter;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Widget_RecyclerViewPager, defStyle,
															0);
        mFlingFactor = a.getFloat(R.styleable.Widget_RecyclerViewPager_widget_rvp_flingFactor, 0.15f);
        mTriggerOffset = a.getFloat(R.styleable.Widget_RecyclerViewPager_widget_rvp_triggerOffset, 0.25f);
        mSinglePageFling = a.getBoolean(R.styleable.Widget_RecyclerViewPager_widget_rvp_singlePageFling, mSinglePageFling);
        isInertia = a.getBoolean(R.styleable.Widget_RecyclerViewPager_widget_rvp_inertia, false);
        mMillisecondsPerInch = a.getFloat(R.styleable.Widget_RecyclerViewPager_widget_rvp_millisecondsPerInch, 25f);
        a.recycle();
    }
     ...
     */
    public int getCenterYChildPosition(RecyclerView recyclerView) {
     ...
     */
    public View getCenterYChild(RecyclerView recyclerView) {
        int childCount = recyclerView.getChildCount();
        if (childCount > 0) {
            for (int i = 0; i < childCount; i++) {
                View child = recyclerView.getChildAt(i);
    ...
    public boolean isChildInCenterY(RecyclerView recyclerView, View view) {
        int childCount = recyclerView.getChildCount();
     ...
     */
    public int getCenterXChildPosition(RecyclerView recyclerView) {
        int childCount = recyclerView.getChildCount();
        if (childCount > 0) {
            for (int i = 0; i < childCount; i++) {
                View child = recyclerView.getChildAt(i);
     ...
     */
    public View getCenterXChild(RecyclerView recyclerView) {
        int childCount = recyclerView.getChildCount();
        if (childCount > 0) {
            for (int i = 0; i < childCount; i++) {
                View child = recyclerView.getChildAt(i);
