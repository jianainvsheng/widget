package com.source.sdk.widget.city.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        final int left = (int) (parent.getPaddingLeft() + parent.getContext().getResources().getDimension(R.dimen.widget_dp_14));
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position > -1) {
                if (position == 0) {//等于0肯定要有title的
                    drawTitleArea(c, drawLeft, right, child, params, position);
