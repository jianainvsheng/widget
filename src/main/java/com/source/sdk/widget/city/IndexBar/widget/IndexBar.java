package com.source.sdk.widget.city.IndexBar.widget;
...
import com.source.sdk.widget.city.IndexBar.bean.BaseIndexPinyinBean;
import com.source.sdk.widget.city.IndexBar.helper.IIndexBarDataHelper;
import com.source.sdk.widget.city.IndexBar.helper.IndexBarDataHelperImpl;
...
public class IndexBar extends View {
    ...
    private List<Integer> mIndexDatasPosition;
        ...
        setmOnIndexPressedListener(new onIndexPressedListener() {
            ...
            public void onIndexPressed(int index, String text) {
                if (mPressedShowTextView != null) { //显示hintTexView
                    ...
                    if(mIndexDatasPosition != null && mIndexDatasPosition.size() > index){
                        int posisionY = mIndexDatasPosition.get(index);
                        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) mPressedShowTextView.getLayoutParams();
                        params.topMargin = posisionY - mPressedShowTextView.getMeasuredHeight()/2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String index;//每个要绘制的index内容
        if(mIndexDatasPosition == null){
            mIndexDatasPosition = new ArrayList<>();
        }
        mIndexDatasPosition.clear();
        for (int i = 0; i < mIndexDatas.size(); i++) {
            index = mIndexDatas.get(i);
            ...
            mIndexDatasPosition.add(t + mGapHeight * i + baseline);
        }
    }
