package com.source.sdk.widget.search.layout;
...
public class SearchLayout extends BaseArrayLayout {
    ...
    public SearchLayout(Context context, AttributeSet attrs, int defStyleAttr) {
      ...
      //  mLeft = (int) context.getResources().getDimension(R.dimen.margin_5dp);
        mRight = (int) context.getResources().getDimension(R.dimen.widget_dp_5);
        mDistance = (int) context.getResources().getDimension(R.dimen.widget_dp_5);
//        mTop = (int) context.getResources().getDimension(R.dimen.margin_riv_add_group);
    ...
    private void checkPositionSize(final int width){
        ...
        if(mAdapter.onAninmotaionDelayed() > 0){
            this.postDelayed(new Runnable() {
                @Override
                public void run() {
                    smoothScrollAnim(width);
                }
            }, mAdapter.onAninmotaionDelayed());
    ...
    private void smoothScrollAnim(final int width){
